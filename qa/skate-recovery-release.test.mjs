...
const runtimeRevision='rail-corner-1';
...
test('camera preparation completes before the world is returned, with one shared module instance',()=>{
 ...
 assert(read('index.html').includes('app/party/party-pack.js?v=rail-corner-1'));
 ...
 for(const key of ['chunk-G7D6MVRW.js','chunk-G7D6MVRW.js?v=online-next-1','chunk-G7D6MVRW.js?v='+revision])assert.equal(imports['/67park-foundation-next/app/'+key],'/67park-foundation-next/app/chunk-G7D6MVRW.js?v=cat-character-1');
