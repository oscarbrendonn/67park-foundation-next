...
test('shared player publishes feedback and entry cache keys include the sound fix',()=>{
  ...
  const html=read('../index.html');assert(html.includes('app/main.js?v=foundation-next-movement-1'));
  assert(html.includes('app/party/party-pack.js?v=foundation-next-movement-1'));
});
