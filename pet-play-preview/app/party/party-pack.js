import {createParkLaunchers} from "/67park-foundation-next/app/party/park-launchers.js?v=hatch-ends-1";
import {createParkPets} from '/67park-foundation-next/app/pets/park-pets.js?v=pets-soft-2';
import {createHousing} from '/67park-foundation-next/app/housing.js?v=rail-corner-1';
import '/67park-foundation-next/app/chat-send-focus.js?v=homes-1';
import {createParkSocialToys} from "/67park-foundation-next/app/party/park-social-toys.js?v=balloon-lift-2";
import {installSkateRailFinish} from '/67park-foundation-next/app/party/skate-rail-finish.js?v=1';
...
import {playerSettings as settings,savePlayerSettings as saveSettings} from '/67park-foundation-next/app/player-settings.js';
import {installPlayerSettings} from '/67park-foundation-next/app/party/settings-panel.js?v=recovery-graphics-1';
import { createPartyAudio } from '/67park-foundation-next/app/party/party-audio.js?v=vehicle-feedback-1';
import {createFeatureBoundary} from '/67park-foundation-next/app/feature-boundary.js';
import {createVehicleHorn} from '/67park-foundation-next/app/party/vehicle-horn.js?v=vehicle-feedback-1';

const BASE = new URL('/67park-foundation-next/', import.meta.url).pathname.replace(/\/$/, '');
