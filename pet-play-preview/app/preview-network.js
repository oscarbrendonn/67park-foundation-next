import {PREVIEW_BACKEND,PREVIEW_VARIANT} from '/67park-foundation-next/app/preview-network-config.js?v=mac-recovery-1';
import {createPreviewEndpointResolver} from '/67park-foundation-next/app/preview-endpoint.js?v=mac-recovery-1';
import {protectParkSocket} from '/67park-foundation-next/app/social-safety.js';
import {CLIENT_PROTOCOL,CLIENT_BUILD,compatibleProtocol} from '/67park-foundation-next/app/protocol-version.js';
import {assertConnectionAllowed,connectionProblem,watchParkSocket,currentParkSocket} from '/67park-foundation-next/app/connection-recovery.js';
...
const published=typeof location!=='undefined'&&location.origin==='https://oscarbrendonn.github.io'&&(location.pathname==='/67park-foundation-next'||location.pathname.startsWith('/67park-foundation-next/'));
